...
if(((cljs.core.set_QMARK_(class$__$1)) || (cljs.core.sequential_QMARK_(class$__$1))) && (cljs.core.every_QMARK_((function (p1__12200_SHARP_){
return ((p1__12200_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__12200_SHARP_ === 'string');
}),class$__$1))){
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(G__12202,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$class], null),sablono.normalize.class$);
} else {
return G__12202;
}
});
...
var len__7548__auto___12206 = arguments.length;
var i__7549__auto___12207 = (0);
while(true){
if((i__7549__auto___12207 < len__7548__auto___12206)){
args__7555__auto__.push((arguments[i__7549__auto___12207]));

var G__12208 = (i__7549__auto___12207 + (1));
i__7549__auto___12207 = G__12208;
continue;
} else {
}
break;
...
return sablono.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(argseq__7556__auto__);
});
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentHashSet.EMPTY,p1__12203_SHARP_);
});})(maps__$1))
...
var G__12205 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.merge,maps__$1);
if(!(cljs.core.empty_QMARK_(classes__$1))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__12205,cljs.core.cst$kw$class,classes__$1);
} else {
return G__12205;
}
});
...
sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq12204){
return sablono.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq12204));
});
/**
...
var vec__12212 = ((cljs.core.empty_QMARK_(matches))?(function(){throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2([cljs.core.str("Can't match CSS tag: "),cljs.core.str(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$tag,s], null))})():(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null).call(null,cljs.core.ffirst(matches)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["div",matches], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(matches),cljs.core.rest(matches)], null)
));
var tag_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12212,(0),null);
var names = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12212,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,cljs.core.first(cljs.core.map.cljs$core$IFn$_invoke$arity$2(sablono.normalize.strip_css,cljs.core.filter.cljs$core$IFn$_invoke$arity$2(((function (matches,vec__12212,tag_name,names){
return (function (p1__12209_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("#",cljs.core.first(p1__12209_SHARP_));
});})(matches,vec__12212,tag_name,names))
,names))),cljs.core.vec(cljs.core.map.cljs$core$IFn$_invoke$arity$2(sablono.normalize.strip_css,cljs.core.filter.cljs$core$IFn$_invoke$arity$2(((function (matches,vec__12212,tag_name,names){
return (function (p1__12210_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(".",cljs.core.first(p1__12210_SHARP_));
});})(matches,vec__12212,tag_name,names))
,names)))], null);
});
/**
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__12213){
var vec__12216 = p__12213;
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12216,(0),null);
var content = cljs.core.nthnext(vec__12216,(1));
...
var vec__12217 = sablono.normalize.match_tag(tag);
var tag__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12217,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12217,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12217,(2),null);
