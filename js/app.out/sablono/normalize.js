...
if(((cljs.core.set_QMARK_(class$__$1)) || (cljs.core.sequential_QMARK_(class$__$1))) && (cljs.core.every_QMARK_((function (p1__12601_SHARP_){
return ((p1__12601_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__12601_SHARP_ === 'string');
}),class$__$1))){
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(G__12603,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$class], null),sablono.normalize.class$);
} else {
return G__12603;
}
});
...
var len__7544__auto___12606 = arguments.length;
var i__7545__auto___12607 = (0);
while(true){
if((i__7545__auto___12607 < len__7544__auto___12606)){
args__7551__auto__.push((arguments[i__7545__auto___12607]));

var G__12608 = (i__7545__auto___12607 + (1));
i__7545__auto___12607 = G__12608;
continue;
} else {
}
break;
...
var G__12605 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.merge,maps__$1);
if(!(cljs.core.empty_QMARK_(classes__$1))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__12605,cljs.core.cst$kw$class,classes__$1);
} else {
return G__12605;
}
});
...
sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq12604){
return sablono.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq12604));
});
/**
...
var vec__12612 = ((cljs.core.empty_QMARK_(matches))?(function(){throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2([cljs.core.str("Can't match CSS tag: "),cljs.core.str(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$tag,s], null))})():(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null).call(null,cljs.core.ffirst(matches)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["div",matches], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(matches),cljs.core.rest(matches)], null)
));
var tag_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12612,(0),null);
var names = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12612,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,cljs.core.first(cljs.core.map.cljs$core$IFn$_invoke$arity$2(sablono.normalize.strip_css,cljs.core.filter.cljs$core$IFn$_invoke$arity$2(((function (matches,vec__12612,tag_name,names){
return (function (p1__12609_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("#",cljs.core.first(p1__12609_SHARP_));
});})(matches,vec__12612,tag_name,names))
,names))),cljs.core.vec(cljs.core.map.cljs$core$IFn$_invoke$arity$2(sablono.normalize.strip_css,cljs.core.filter.cljs$core$IFn$_invoke$arity$2(((function (matches,vec__12612,tag_name,names){
return (function (p1__12610_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(".",cljs.core.first(p1__12610_SHARP_));
});})(matches,vec__12612,tag_name,names))
,names)))], null);
});
/**
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__12614){
var vec__12617 = p__12614;
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12617,(0),null);
var content = cljs.core.nthnext(vec__12617,(1));
...
var vec__12618 = sablono.normalize.match_tag(tag);
var tag__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12618,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12618,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12618,(2),null);
