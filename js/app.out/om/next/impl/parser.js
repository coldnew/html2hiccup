...
om.next.impl.parser.call__GT_ast = (function om$next$impl$parser$call__GT_ast(p__12360){
var vec__12363 = p__12360;
var f = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12363,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12363,(1),null);
var call = vec__12363;
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__12364,cljs.core.cst$kw$type,cljs.core.cst$kw$call);
} else {
return G__12364;
}
}
...
var vec__12366 = cljs.core.first(join);
...
om.next.impl.parser.ref__GT_ast = (function om$next$impl$parser$ref__GT_ast(p__12367){
var vec__12369 = p__12367;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12369,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12369,(1),null);
var ref = vec__12369;
...
return cljs.core.with_meta((function (){var G__12371 = expr;
if((expr instanceof cljs.core.Keyword)){
var x__7374__auto__ = G__12371;
 ...
 */
om.next.impl.parser.ast__GT_expr = (function om$next$impl$parser$ast__GT_expr(p__12372){
var map__12379 = p__12372;
var map__12379__$1 = ((((!((map__12379 == null)))?((((map__12379.cljs$lang$protocol_mask$partition0$ & (64))) || (map__12379.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__12379):map__12379);
var ast = map__12379__$1;
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12379__$1,cljs.core.cst$kw$key);
var query = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12379__$1,cljs.core.cst$kw$query);
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12379__$1,cljs.core.cst$kw$params);
var root = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12379__$1,cljs.core.cst$kw$query_SLASH_root);
...
var x_SINGLEQUOTE_ = (function (){var G__12392 = x;
var G__12392__$1 = ((cljs.core.map_QMARK_(x))?cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1(((function (G__12392){
return (function (p__12393){
var vec__12394 = p__12393;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12394,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12394,(1),null);
...
if(cljs.core.vector_QMARK_(x)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.map_indexed.cljs$core$IFn$_invoke$arity$1(((function (G__12392,G__12392__$1){
return (function (p1__12382_SHARP_,p2__12381_SHARP_){
return om$next$impl$parser$path_meta(p2__12381_SHARP_,cljs.core.conj.cljs$core$IFn$_invoke$arity$2(path,p1__12382_SHARP_));
});})(G__12392,G__12392__$1))
),G__12392__$1);
} else {
return G__12392__$1;
}
})();
var G__12395 = x_SINGLEQUOTE_;
...
return cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$4(G__12395,cljs.core.assoc,cljs.core.cst$kw$om_DASH_path,path);
} else {
return G__12395;
}
});
 ...
 */
om.next.impl.parser.parser = (function om$next$impl$parser$parser(p__12397){
var map__12464 = p__12397;
...
var config = map__12464__$1;
var read = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12464__$1,cljs.core.cst$kw$read);
var mutate = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12464__$1,cljs.core.cst$kw$mutate);
return ((function (map__12464,map__12464__$1,config,read,mutate){
return (function() {
...
var map__12498 = (function (){var G__12499 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(env,cljs.core.cst$kw$parser,om$next$impl$parser$parser_$_self,cljs.core.array_seq([cljs.core.cst$kw$target,target,cljs.core.cst$kw$query_SLASH_root,cljs.core.cst$kw$om$next_SLASH_root], 0));
if(!(cljs.core.contains_QMARK_(env,cljs.core.cst$kw$path))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__12499,cljs.core.cst$kw$path,cljs.core.PersistentVector.EMPTY);
} else {
return G__12499;
}
})();
var map__12498__$1 = ((((!((map__12498 == null)))?((((map__12498.cljs$lang$protocol_mask$partition0$ & (64))) || (map__12498.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__12498):map__12498);
var env__$1 = map__12498__$1;
var path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12498__$1,cljs.core.cst$kw$path);
var step = ((function (elide_paths_QMARK_,map__12498,map__12498__$1,env__$1,path,map__12464,map__12464__$1,config,read,mutate){
return (function om$next$impl$parser$parser_$_self_$_step(ret,expr){
var map__12522 = om.next.impl.parser.expr__GT_ast(expr);
...
var ast = map__12522__$1;
var query_SINGLEQUOTE_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12522__$1,cljs.core.cst$kw$query);
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12522__$1,cljs.core.cst$kw$key);
var dispatch_key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12522__$1,cljs.core.cst$kw$dispatch_DASH_key);
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12522__$1,cljs.core.cst$kw$params);
var env__$2 = (function (){var env__$2 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(env__$1,cljs.core.cst$kw$ast,ast);
var env__$3 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.cst$sym$$$$,query_SINGLEQUOTE_))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(env__$2,cljs.core.cst$kw$query,query):(function (){var G__12524 = env__$2;
if(!((query_SINGLEQUOTE_ == null))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__12524,cljs.core.cst$kw$query,query_SINGLEQUOTE_);
} else {
return G__12524;
}
})());
...
var res = (((cljs.core.cst$kw$target.cljs$core$IFn$_invoke$arity$1(ast) == null))?(function (){var G__12525 = (((type instanceof cljs.core.Keyword))?type.fqn:null);
switch (G__12525) {
case "call":
...
var G__12526 = ret;
var G__12526__$1 = ((ast_SINGLEQUOTE_ === true)?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(G__12526,expr):G__12526);
var G__12526__$2 = ((cljs.core.map_QMARK_(ast_SINGLEQUOTE_))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(G__12526__$1,om.next.impl.parser.ast__GT_expr(ast_SINGLEQUOTE_)):G__12526__$1);
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(target,cljs.core.cst$kw$target.cljs$core$IFn$_invoke$arity$1(ast))){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(G__12526__$2,om.next.impl.parser.ast__GT_expr(ast));
} else {
return G__12526__$2;
}
} else {
...
}catch (e12527){var e_12531 = e12527;
if(cljs.core.truth_(om.next.impl.parser.rethrow_QMARK_(e_12531))){
throw e_12531;
} else {
(cljs.core.reset_BANG_.cljs$core$IFn$_invoke$arity$2 ? cljs.core.reset_BANG_.cljs$core$IFn$_invoke$arity$2(error,e_12531) : cljs.core.reset_BANG_.call(null,error,e_12531));
}
}} else {
}
...
var G__12528 = ret;
var G__12528__$1 = ((!((value == null)))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__12528,key,value):G__12528);
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__12528__$1,key,(cljs.core.deref.cljs$core$IFn$_invoke$arity$1 ? cljs.core.deref.cljs$core$IFn$_invoke$arity$1(error) : cljs.core.deref.call(null,error)));
} else {
return G__12528__$1;
}
}
}
});})(elide_paths_QMARK_,map__12498,map__12498__$1,env__$1,path,map__12464,map__12464__$1,config,read,mutate))
;
var G__12529 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(step,(((target == null))?cljs.core.PersistentArrayMap.EMPTY:cljs.core.PersistentVector.EMPTY),query);
if(!((!((target == null))) || (elide_paths_QMARK_))){
return om.next.impl.parser.path_meta(G__12529,path);
} else {
return G__12529;
}
});
...
;})(map__12464,map__12464__$1,config,read,mutate))
});
