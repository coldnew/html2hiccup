...
var pred__14359 = cljs.core._EQ_;
var expr__14360 = (this$["nodeType"]);
if(cljs.core.truth_((pred__14359.cljs$core$IFn$_invoke$arity$2 ? pred__14359.cljs$core$IFn$_invoke$arity$2(hickory.core.Attribute,expr__14360) : pred__14359.call(null,hickory.core.Attribute,expr__14360)))){
...
if(cljs.core.truth_((pred__14359.cljs$core$IFn$_invoke$arity$2 ? pred__14359.cljs$core$IFn$_invoke$arity$2(hickory.core.Comment,expr__14360) : pred__14359.call(null,hickory.core.Comment,expr__14360)))){
return [cljs.core.str("<!--"),cljs.core.str((this$["data"])),cljs.core.str("-->")].join('');
} else {
if(cljs.core.truth_((pred__14359.cljs$core$IFn$_invoke$arity$2 ? pred__14359.cljs$core$IFn$_invoke$arity$2(hickory.core.Document,expr__14360) : pred__14359.call(null,hickory.core.Document,expr__14360)))){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2(hickory.core.as_hiccup,(this$["childNodes"]));
} else {
if(cljs.core.truth_((pred__14359.cljs$core$IFn$_invoke$arity$2 ? pred__14359.cljs$core$IFn$_invoke$arity$2(hickory.core.DocumentType,expr__14360) : pred__14359.call(null,hickory.core.DocumentType,expr__14360)))){
return hickory.core.format_doctype(this$);
} else {
if(cljs.core.truth_((pred__14359.cljs$core$IFn$_invoke$arity$2 ? pred__14359.cljs$core$IFn$_invoke$arity$2(hickory.core.Element,expr__14360) : pred__14359.call(null,hickory.core.Element,expr__14360)))){
var tag = hickory.utils.lower_case_keyword((this$["tagName"]));
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag,cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$2(hickory.core.as_hiccup,(this$["attributes"])))], null),(cljs.core.truth_((hickory.utils.unescapable_content.cljs$core$IFn$_invoke$arity$1 ? hickory.utils.unescapable_content.cljs$core$IFn$_invoke$arity$1(tag) : hickory.utils.unescapable_content.call(null,tag)))?cljs.core.map.cljs$core$IFn$_invoke$arity$2(((function (tag,pred__14359,expr__14360){
return (function (p1__14358_SHARP_){
return (p1__14358_SHARP_["wholeText"]);
});})(tag,pred__14359,expr__14360))
,(this$["childNodes"])):cljs.core.map.cljs$core$IFn$_invoke$arity$2(hickory.core.as_hiccup,(this$["childNodes"])))));
} else {
if(cljs.core.truth_((pred__14359.cljs$core$IFn$_invoke$arity$2 ? pred__14359.cljs$core$IFn$_invoke$arity$2(hickory.core.Text,expr__14360) : pred__14359.call(null,hickory.core.Text,expr__14360)))){
return hickory.utils.html_escape((this$["wholeText"]));
} else {
throw (new Error([cljs.core.str("No matching clause: "),cljs.core.str(expr__14360)].join('')));
}
}
}
}
...
var expr__14363 = (this$["nodeType"]);
if(cljs.core.truth_((pred__14362.cljs$core$IFn$_invoke$arity$2 ? pred__14362.cljs$core$IFn$_invoke$arity$2(hickory.core.Attribute,expr__14363) : pred__14362.call(null,hickory.core.Attribute,expr__14363)))){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [hickory.utils.lower_case_keyword((this$["name"])),(this$["value"])], null);
} else {
if(cljs.core.truth_((pred__14362.cljs$core$IFn$_invoke$arity$2 ? pred__14362.cljs$core$IFn$_invoke$arity$2(hickory.core.Comment,expr__14363) : pred__14362.call(null,hickory.core.Comment,expr__14363)))){
...
if(cljs.core.truth_((pred__14362.cljs$core$IFn$_invoke$arity$2 ? pred__14362.cljs$core$IFn$_invoke$arity$2(hickory.core.Document,expr__14363) : pred__14362.call(null,hickory.core.Document,expr__14363)))){
...
if(cljs.core.truth_((pred__14362.cljs$core$IFn$_invoke$arity$2 ? pred__14362.cljs$core$IFn$_invoke$arity$2(hickory.core.DocumentType,expr__14363) : pred__14362.call(null,hickory.core.DocumentType,expr__14363)))){
...
if(cljs.core.truth_((pred__14362.cljs$core$IFn$_invoke$arity$2 ? pred__14362.cljs$core$IFn$_invoke$arity$2(hickory.core.Element,expr__14363) : pred__14362.call(null,hickory.core.Element,expr__14363)))){
...
if(cljs.core.truth_((pred__14362.cljs$core$IFn$_invoke$arity$2 ? pred__14362.cljs$core$IFn$_invoke$arity$2(hickory.core.Text,expr__14363) : pred__14362.call(null,hickory.core.Text,expr__14363)))){
return (this$["wholeText"]);
} else {
throw (new Error([cljs.core.str("No matching clause: "),cljs.core.str(expr__14363)].join('')));
}
}
}
}
...
var temp__4657__auto___14365 = cljs.core.first((doc["head"]["childNodes"]));
if(cljs.core.truth_(temp__4657__auto___14365)){
var title_el_14366 = temp__4657__auto___14365;
if(cljs.core.empty_QMARK_((title_el_14366["text"]))){
hickory.core.remove_el(title_el_14366);
} else {
}
} else {
}
